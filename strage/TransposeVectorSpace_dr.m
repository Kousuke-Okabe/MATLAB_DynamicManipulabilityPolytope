...
nState = 100;
nVector = 5;
dr = [linspace(-2.2,2.2,nState); zeros(1,nState)];
dz = 20;
...
plot3(r(1)+V(1,:)*Gr,r(2)+V(2,:)*Gr,V(3,:)*Gz,'g')
text(r(1)+V(1,1)*Gr,r(2)+V(2,1)*Gr,V(3,1)*Gz, strcat('$$\leftarrow \dot{r}_1$$=',num2str(dr(1,1))), 'Interpreter','latex', 'FontSize',20)
text(r(1)+V(1,nState)*Gr,r(2)+V(2,nState)*Gr,V(3,nState)*Gz, strcat('$$\leftarrow \dot{r}_1$$=',num2str(dr(1,nState))), 'Interpreter','latex', 'FontSize',20)
